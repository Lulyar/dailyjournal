 ...
 <section id="profil" class="p-5 bg-primary-subtle">
      ...
      >
        <div class="row d-flex align-items-center justify-content-center">
          ...
          >
            <div class="card-body">
              <h5 class="card-title">Luly Angga Ramadhan</h5>
              <br />
              <h6 class="card-text"><b>NIM</b>: A11.2023.15063</h6>
              <h6 class="card-text">
                <b>Program Studi</b>: Teknik Informatika
              </h6>
              <h6 class="card-text"><b>Email</b>: lulyangga44@gmail.com</h6>
